  ...
  return (
    <>
      ...
      {modal === "chapter" && (
        <Modal
          title="Chapter settings"
          subtitle="These apply to every member's progress and the yearly goal."
          onClose={close}
        >
          <form action={updateChapterAction} className="space-y-4">
            ...
            <div>
              <label htmlFor="yearlyHoursGoal" className={label}>
                Yearly service-hours goal
              </label>
              <input
                id="yearlyHoursGoal"
                name="yearlyHoursGoal"
                type="number"
                step="0.5"
                min="0.5"
                defaultValue={yearlyHoursGoal}
                required
                className={field}
              />
